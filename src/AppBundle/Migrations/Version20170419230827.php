 ...
 */
class Version20170419230827 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE properties_product ADD CONSTRAINT FK_4DCF05803DA5256D FOREIGN KEY (image_id) REFERENCES media__media (id) ON DELETE SET NULL');
    }

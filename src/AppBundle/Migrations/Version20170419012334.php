 ...
 */
class Version20170419012334 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE properties_product ADD type VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, DROP type_id');
    }
}

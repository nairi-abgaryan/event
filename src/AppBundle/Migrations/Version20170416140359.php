 ...
 */
class Version20170416140359 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE properties_product ADD image VARCHAR(255) NOT NULL, DROP image_id');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE properties_product ADD CONSTRAINT FK_4DCF05803DA5256D FOREIGN KEY (image_id) REFERENCES images (id)');
